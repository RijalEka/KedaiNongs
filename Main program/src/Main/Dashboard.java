...
public class Dashboard extends javax.swing.JFrame {
    ...
    private String tableName = "tabel_order"; // Default tabel pesanan
    ...
    // Constructor dengan DatabaseConnection tambahan
    public Dashboard(int loggedInKasirId, Pesanan pesanan, DatabaseConnection dbConnection) {
        initComponents();
        this.loggedInKasirId = loggedInKasirId;
        this.pesanan = pesanan;
    ...
    // Tambahan baru: setter untuk nama tabel
